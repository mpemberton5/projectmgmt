...
//$content .= "							<li><a href=\"javascript:void(0)\" onclick='fb.start({ href:\"projects.php?action=popupProjectPrint&project_id=".$project_id."\", rev:\"width:665 height:515 infoPos:tc showClose:false disableScroll:true caption:`Print Project` doAnimations:false\", title:\"TEST\" }); return false;'><img src='images/blank.gif' width='10px' height='10px'>&nbsp;&nbsp;Print</a></li>\n";
$content .= "					</ul>\n";
$content .= "				</li>\n";
$content .= "			</ul>\n";
$content .= "		</div>\n";
...
if ($_GET['action']=="showTopLevel") {
	...
	$content .= "			<li><a href=\"javascript:void(0)\">Action</a>\n";
	$content .= "				<ul>\n";
	$content .= "					<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=organize&project_id=".$project_id."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`ORGANIZE Milestones` doAnimations:false\" }); return false;'>Organize</a></li>\n";
	$content .= "					<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=popupAdd&project_id=".$project_id."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`NEW Milestone` doAnimations:false\" }); return false;'>New</a></li>\n";
	$content .= "				</ul>\n";
	$content .= "			</li>\n";
	$content .= "		</ul>\n";
	$content .= "	</div>\n";
	...
	if ($task_id>0) {
		$milestone_row = db_fetch_array(db_query("select t.* from tasks t where t.task_ID=".$task_id),0);
	}
	...
	$content .= "					<ul>\n";
	$content .= "						<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=organize&project_id=".$project_id."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`ORGANIZE Milestones` doAnimations:false\" }); return false;'>Organize</a></li>\n";
	$content .= "						<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=popupEdit&project_id=".$project_id."&task_id=".$task_id."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`EDIT Milestone` doAnimations:false\" }); return false;'>Edit</a></li>\n";
	$content .= "						<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=popupAdd&project_id=".$project_id."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`NEW Milestone` doAnimations:false\" }); return false;'>New</a></li>\n";
	$content .= "					</ul>\n";
	$content .= "				</li>\n";
	$content .= "			</ul>\n";
	...
	$content .= "			<td class=\"nt\" valign=\"top\" style=\"align: left; width: 11%;\"><b>Current Task:&nbsp;</b></td>\n";
	$content .= "			<td class=\"nt\" style=\"align: left; width: 40%;\"><div style=\"white-space:normal;\">".$currTaskName."</div></td>\n";
	...
	$content .= "			<li><a href=\"javascript:void(0)\">Action</a>\n";
	$content .= "				<ul>\n";
	$content .= "					<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=organize&project_id=".$project_id."&task_id=".$task_id."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`ORGANIZE Tasks` doAnimations:false\" }); return false;'>Organize</a></li>\n";
	$content .= "					<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=popupAdd&project_id=".$project_id."&task_id=".$task_id."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`NEW Task` doAnimations:false\" }); return false;'>New Task</a></li>\n";
	$content .= "					<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=popupAddPL&project_id=".$project_id."&task_id=".$task_id."\", rev:\"width:650 height:122 infoPos:tc disableScroll:true caption:`NEW Project Link` doAnimations:false\" }); return false;'>New Project Link</a></li>\n";
	$content .= "				</ul>\n";
	$content .= "			</li>\n";
	$content .= "		</ul>\n";
	$content .= "	</div>\n";
	...
	if ($milestone_ID>0) {
		$milestone_row = db_fetch_array(db_query("select t.* from tasks t where t.task_ID=".$milestone_ID),0);
	}
	...
	$content .= "					<ul>\n";
	$content .= "						<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=organize&project_id=".$project_id."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`ORGANIZE Milestones` doAnimations:false\" }); return false;'>Organize</a></li>\n";
	$content .= "						<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=popupEdit&project_id=".$project_id."&task_id=".$milestone_ID."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`EDIT Milestone` doAnimations:false\" }); return false;'>Edit</a></li>\n";
	$content .= "						<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=popupAdd&project_id=".$project_id."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`NEW Milestone` doAnimations:false\" }); return false;'>New</a></li>\n";
	$content .= "					</ul>\n";
	$content .= "				</li>\n";
	$content .= "			</ul>\n";
	...
	$content .= "			<td class=\"nt\" valign=\"top\" style=\"align: left; width: 1%;\"><b>Name:&nbsp;</b></td>\n";
	$content .= "			<td class=\"nt\" style=\"align: left; width: 40%;\"><div style=\"white-space:normal;\">".nl2br(html_links($milestone_row['task_name']))."</div></td>\n";
	$content .= "			<td class=\"nt\" valign=\"top\" style=\"width: 11%; align: left;\"><b>Current Task:&nbsp;</b></td>\n";
	$content .= "			<td class=\"nt\" style=\"align: left; width: 40%;\"><div style=\"white-space:normal;\">".$currTaskName."</div></td>\n";
	$content .= "			<td class=\"nt\" style=\"text-align: right; color: #15A50D; font-size: 20px; font-weight: bold;\" rowspan=\"2\">".$milestone_row['PercentComplete']."%</td>\n";
	$content .= "		</tr>\n";
	$content .= "		<tr class=\"nt\" style=\"align: left;\">\n";
	...
	if ($task_row['ParentProjectLink_ID']==0) {
		$content .= "	<div style=\"position: absolute; width: 1px;\">\n";
		$content .= "		<div style=\"position: relative; float: left; top: -21px; right: -260px;\">\n";
		$content .= "			<ul class=\"jsddm\">\n";
		$content .= "				<li><a href=\"javascript:void(0)\">Action</a>\n";
		$content .= "					<ul>\n";
		$content .= "						<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=popupEdit&project_id=".$project_id."&task_id=".$task_id."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`EDIT Task` doAnimations:false\" }); return false;'>Edit</a></li>\n";
		$content .= "						<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=popupAdd&project_id=".$project_id."&task_id=".$milestone_ID."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`NEW Task` doAnimations:false\" }); return false;'>New Task</a></li>\n";
		$content .= "						<li><a href=\"javascript:void(0)\" onclick='fb.start({ href: \"tasks.php?action=popupAddPL&project_id=".$project_id."&task_id=".$milestone_ID."\", rev:\"width:650 height:122 infoPos:tc disableScroll:true caption:`NEW Project Link` doAnimations:false\" }); return false;'>New Project Link</a></li>\n";
		$content .= "					</ul>\n";
		$content .= "				</li>\n";
		$content .= "			</ul>\n";
		$content .= "		</div>\n";
		...
		$content .= "				<li><a href=\"javascript:void(0);\">Action</a>\n";
		$content .= "					<ul>\n";
		$content .= "						<li><a href=\"javascript:void(0);\" onclick='fb.start({ href: \"tasks.php?action=popupRemovePL&project_id=".$project_id."&milestone_id=".$milestone_ID."&task_id=".$task_id."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`REMOVE Project Link` doAnimations:false\" }); return false;'>Remove Project Link</a></li>\n";
		$content .= "						<li><a href=\"javascript:void(0);\" onclick='fb.start({ href: \"tasks.php?action=popupAdd&project_id=".$project_id."&task_id=".$milestone_ID."\", rev:\"width:650 height:430 infoPos:tc disableScroll:true caption:`NEW Task` doAnimations:false\" }); return false;'>New Task</a></li>\n";
		$content .= "						<li><a href=\"javascript:void(0);\" onclick='fb.start({ href: \"tasks.php?action=popupAddPL&project_id=".$project_id."&task_id=".$milestone_ID."\", rev:\"width:650 height:122 infoPos:tc disableScroll:true caption:`NEW Project Link` doAnimations:false\" }); return false;'>New Project Link</a></li>\n";
		$content .= "					</ul>\n";
		$content .= "				</li>\n";
		...
		$parent_project_row = db_fetch_array(db_query("select * from projects where project_ID=".$task_row['ParentProjectLink_ID']),0);

		$content .= "<br />\n";
		$content .= "	<table class=\"nt\" style=\"width: 96%; margin-right:auto; margin-left:auto; \">\n";
		$content .= "		<tr class=\"nt\" style=\"align: left;\">\n";
		$content .= "				<td>Child Project Link&nbsp;&nbsp;&nbsp;<img style=\"vertical-align: text-bottom;\" src=\"images/green_double_arrow_right.png\" />&nbsp;&nbsp;<a href=\"projects.php?action=show&project_id=".$task_row['ParentProjectLink_ID']."\"><b>".$parent_project_row['Project_Name']."</b></a></td>";
		$content .= "				<td><b>Status:</b> ".$parent_project_row['Status']."</td>\n";
		$content .= "				<td>".$parent_project_row['PercentComplete']."%</td>\n";
		$content .= "		</tr>\n";
		$content .= "	</table>\n";
		$content .= "<br />\n";
		//$content .= "	<div style=\"margin: 5px 5px 5px 15px;\">\n";
//		$content .= "		<table style=\"width: 96%;\">\n";
//		$content .= "			<tr>\n";
//		$content .= "				<td>Child Project Link&nbsp;&nbsp;&nbsp;<img style=\"vertical-align: text-bottom;\" src=\"images/green_double_arrow_right.png\" />&nbsp;&nbsp;<a href=\"projects.php?action=show&project_id=".$task_row['ParentProjectLink_ID']."\"><b>".$parent_project_row['Project_Name']."</b></a></td>";
//		$content .= "				<td><b>Status:</b> ".$parent_project_row['Status']."</td>\n";
//		$content .= "				<td>".$parent_project_row['PercentComplete']."%</td>\n";
...
//		$content .= "		</table>\n";
	...
	if ($task_row['ParentProjectLink_ID']==0) {
		...
		$content .= "			<a href=\"javascript:void(0);\" onclick='fb.start({ href: \"task_notes.php?action=popupAdd&project_id=".$project_id."&task_id=".$task_id."\", rev:\"width:670 height:470 infoPos:tc disableScroll:true caption:`NEW Task Note` doAnimations:false\" }); return false;'>New</a>\n";
		$content .= "		</div>\n";
		$content .= "	</div>\n";
		...
		if (db_numrows($q) > 0) {
			...
			for ($i=0; $row = @db_fetch_array($q, $i); ++$i) {
				...
				$content .= "<div style=\"clear:both;\"><div style=\"float:left;\"><b>Entry Posted:</b> ".$row['TimeStamp']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Percent Complete:</b> ".$row['PercentComplete']."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Posted By:</b> ".$posted_by."</div><div style=\"float:right; margin: 0 10px 0 0px;\"><a href=\"javascript:void(0);\" onclick='fb.start({ href: \"task_notes.php?action=popupEdit&project_id=".$project_id."&task_id=".$task_id."&note_id=".$row['note_ID']."\", rev:\"width:670 height:470 infoPos:tc disableScroll:true caption:`EDIT Task Note` doAnimations:false\" }); return false;'><img alt=\"Edit\" title=\"Edit\" src=\"images/edit_pencil.jpg\" /></a></div></div>\n";
				$content .= "<div style=\"clear:both; white-space:normal;\" id=\"note".$i."\" class=\"generalbox\"></div><br />\n";
			}
			$tmpcontent .= "});\n";
			$tmpcontent .= "</script>\n";
